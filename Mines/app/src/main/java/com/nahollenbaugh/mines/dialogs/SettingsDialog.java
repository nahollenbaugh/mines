...
public class SettingsDialog extends DialogFragment {
    ...
    public void show(boolean doubleTapDelay,
                     boolean doubleTapFlags, boolean noguess, boolean chord,
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        ScrollView wrapper = new ScrollView(f.requireContext(), null);
